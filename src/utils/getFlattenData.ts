...
// textArea 元数据 数组
const ROOT_ARR_PREFIX = 'ROOT_ARR_PREFIX';

// 后端存在的数据数组，并填充完了 后端数据
const EXIST_ARR_PREFIX = 'EXIST_ARR_PREFIX';

// 新增数据数组
const ADD_ARR_PREFIX = 'ADD_ARR_PREFIX';

// 填充了属性的 新增数据数组
const HANDLE_ADD_ARR_PREFIX = 'HANDLE_ADD_ARR_PREFIX';
 ...
 */
export const flattenChainedData = (data) => {
  let arr = [];
